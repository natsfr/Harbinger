...
#
# harbinger_project.tcl: Tcl script for re-creating project 'harbinger_synth'
#
# Generated by Vivado on Thu Feb 09 12:26:24 CET 2023
...
#
# 1. This project restoration tcl script (harbinger_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/nats/data/projects/Harbinger/HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/home/nats/data/projects/Harbinger/HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/fifo_generator_0/fifo_generator_0.xci"
#    "/home/nats/data/projects/Harbinger/HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/ila_0/ila_0.xci"
#
...
#    "/home/nats/data/projects/Harbinger/HDL/src/generic_macro.vh"
#    "/home/nats/data/projects/Harbinger/HDL/spartan7/pins.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "harbinger_synth"
...
set script_file "harbinger_project.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../HDL/spartan7/harbinger_synth"]"
...
set files [list \
 [file normalize "${origin_dir}/../HDL/src/dual_fast_spi.v"] \
 [file normalize "${origin_dir}/../HDL/src/i2s.v"] \
 [file normalize "${origin_dir}/../HDL/src/operator.v"] \
 [file normalize "${origin_dir}/../HDL/src/voice.v"] \
 [file normalize "${origin_dir}/../HDL/src/top.v"] \
 [file normalize "${origin_dir}/../HDL/src/midi_parser.v"] \
 [file normalize "${origin_dir}/../HDL/src/uart_rx.v"] \
 [file normalize "${origin_dir}/../HDL/src/generic_macro.vh"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../HDL/src/dual_fast_spi.v"
...
set file "$origin_dir/../HDL/src/i2s.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/operator.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/voice.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/midi_parser.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/uart_rx.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../HDL/src/generic_macro.vh"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "verilog_define" -value "SPARTAN7=1" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci" ]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/fifo_generator_0/fifo_generator_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../HDL/spartan7/harbinger_synth/harbinger_synth.srcs/sources_1/ip/ila_0/ila_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
set file "[file normalize "$origin_dir/../HDL/spartan7/pins.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../HDL/spartan7/pins.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/../HDL/spartan7/pins.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/../HDL/spartan7/pins.xdc"]" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/harbinger_synth.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/harbinger_synth.srcs/utils_1/imports/impl_1" -objects $obj
