...
HD_PWD='/home/nats/data/projects/Harbinger/HDL_v2/vivado_crap/harb_v2/harb_v2.runs/SPI_FIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_FIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_FIFO.tcl
